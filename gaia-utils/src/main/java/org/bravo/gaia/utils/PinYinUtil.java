...
public class PinYinUtil {
	...
	public static Set<String> hanyuToPyAndJp(String hanyu, String separator)
		...
		convert(separator, resultSet, resultSet2);
		return resultSet;
	}

	private static void convert(String separator, Set<String> resultSet, Set<String> resultSet2) {
	...
	public static Set<String> hanyuToJp(String hanyu) throws Exception {
		...
		convert(separator, jpSet, resultSet);
		return jpSet;
	}
